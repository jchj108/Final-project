							...
							<div class="card">
								...
								<div class="card-body p-0">
									<ul class="nav nav-pills flex-column">
										...
										<li class="nav-item thispage"><a href="${contextPath }/deletelist.mail" class="nav-link"> <i
												class="far fa-trash-alt mail-icon thispage"></i> <b>휴지통</b>
										</a></li>
									</ul>
								</div>
								<!-- /.card-body -->
							...
							<div class="card card-primary card-outline">
								...
								<div class="card-body p-0">
									<div class="mailbox-controls">
										...
										<!-- /.btn-group -->
										<button type="button"
											onclick="location.href='deletelist.mail'"
									...
									<div class="table-responsive mailbox-messages">
										<table class="table table-hover table-striped">
											<form id="receiveManage" method="post">
												...
												<c:forEach var="m" items="${deleteList }"
													varStatus="idCount">
